...
import '../../../settings/presentation/pages/notification_filters_page.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: const Text(
                  'Filtrar mensagens notificadas',
                  style: TextStyle(color: Colors.white),
                ),
                subtitle: Text(
                  _backgroundNotifyFilterEnabled
                      ? 'Ativo: ${_backgroundNotifyAllowedPatterns.length} filtro(s)'
                      : 'Desativado',
                ...
                onTap: () async {
                  await Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (_) => const NotificationFiltersPage(),
                    ),
                  );
                  await _loadSettings();
                },
              ...
              SizedBox(
                ...
                child: OutlinedButton(
                  ...
                  child: const Text('Acessar Nova Interface', style: TextStyle(fontSize: 16)),
                ),
              ),
            ],
          ),
