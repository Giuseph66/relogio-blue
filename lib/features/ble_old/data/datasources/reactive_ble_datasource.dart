...
class ReactiveBleDataSource {
  ...
  Stream<ConnectionState> connectToDevice(
    ...
    final connectionController = _ensureConnectionStateController();

    if (_mockMode) {
      _mockConnect(deviceId);
  ...
  void _mockConnect(String deviceId) {
    final controller = _ensureConnectionStateController();
    _connectedDeviceId = deviceId;
  ...
  Future<void> disconnectDevice() async {
    ...
    _clearNotifySubscription();
    connectionController.add(ConnectionState.disconnecting);
  ...
  Stream<ConnectionState> getConnectionState() {
    return _ensureConnectionStateController().stream;
  }
